...
namespace TrueAccounts.Migrations
{
    ...
    [Migration("20230720044926_updateBranchAddress")]
    partial class updateBranchAddress
    {
            ...
            modelBuilder.Entity("TrueAccounts.Models.JVInvDetail", b =>
                {
                    ...
                    b.HasIndex("JvInvoiceId");

                    b.ToTable("JVInvDetails");
                });

            modelBuilder.Entity("TrueAccounts.Models.JVInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
